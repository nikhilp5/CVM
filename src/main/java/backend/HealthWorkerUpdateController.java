...
public class HealthWorkerUpdateController implements IHealthWorkerUpdateController{
	...
	public HealthWorkerUpdateController(final IDatabaseConnection
			databaseConnection,
			final IUserQuery
			userQuery) {
	...
	public User checkHealthWorkerExists(String firstName,String lastName,String emailId) {
		try {
			...
			String selectUserQuery = userQuery.getHealthWorker(firstName,lastName,emailId);
	...
	public boolean updateHealthWorkerDetails(User user,final HashMap<String,String> updateValues) {
		try {
			...
			Statement statement = databaseConnection.getDatabaseConnection().createStatement();
			String updateUserQuery = userQuery.updateHealthWorker(user,updateValues);
	...
	private ArrayList<String> validateUserInputs(HashMap<String,String> updateValues){
